...
| ![Dashboard - Game Selected](../assets/Dashboard_Box_Art.jpg){ data-gallery="overview" } |
|---|
...
| ![Library - Carousel View](../assets/Carousel_Library.jpg){ data-gallery="overview" } |
|---|
| Library - Carousel View |

| ![Library - List View](../assets/List_Library.png){ data-gallery="overview" } |
|---|
| Library - List View |
...
| ![Game Details - Achievements Pane](../assets/Game_Details_Achievements.png){ data-gallery="overview" } |
|---|
...
| ![Gallery - Thumbnail Grid](../assets/Gallery.jpg){ data-gallery="overview" } |
|---|
...
| ![Profiles - Profile Picker](../assets/Profile_Selection.png){ data-gallery="overview" } |
|---|
