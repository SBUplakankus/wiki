...
- New here? Start with [Installation](getting-started/installation.md), then follow the [Quickstart](getting-started/quickstart.md).
- Looking for a specific screen? Browse the [Guides](guides/library.md).
- Something not working? Check [Troubleshooting](help/troubleshooting.md) and the [FAQ](help/faq.md).
- Want to build it yourself? See [Development](help/development.md).
